  ...
  public products = [
    {
      ...
      description:
        "Bursting with orange and lemon flavors, it's the perfect treat to make every day a sunny day!",
    },
    {
      id: 2,
      ...
      name: 'Velvety Red',
      description:
        'Chocolate, cream cheese, and velvety red... This classic treat is sure to delight!',
    },
    {
      id: 3,
      ...
      name: 'Chocoholic',
      description:
        'Deep flavors of dark chocolate are in every bite. With a chocolate cake and fudgey frosting!',
    },
    {
      id: 4,
      ...
      description:
        'A sure favorite for kids of all ages. Vanilla cake, pink frosting, and a cherry on top!',
    },
    {
      id: 5,
      ...
      name: 'Choco Minty',
      description:
        'Dark chocolate cake with a minty frosting. A delicious combination of refreshing and decadent.',
    },
    {
      id: 6,
      ...
      description:
        'When strawberries are in season, we celebrate with strawberry in every bite.',
    },
    {
      id: 7,
      ...
      name: 'Hazelate',
      description:
        'Chocolate and hazelnut together is perfection. Our weekly special might be perfect as a result!',
    },
    {
      id: 8,
      ...
      name: 'Yum Pack',
      description:
        'Need some extra sweets? Take home a four pack of delicious treats!',
    },
  ];
